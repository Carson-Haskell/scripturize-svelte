import { g as get_store_value, c as create_ssr_component, a as add_attribute, e as escape, b as add_styles, d as compute_slots, f as subscribe, v as validate_component } from "../../chunks/ssr.js";
...
const ThemeToggle = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_theme();
  return `<label class="transition-transform duration-300 swap swap-rotate hover:scale-110"> <input type="checkbox" ${$theme === "winter" ? "checked" : ""}>  <svg class="w-6 h-6 fill-current swap-on" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M5.64,17l-.71.71a1,1,0,0,0,0,1.41,1,1,0,0,0,1.41,0l.71-.71A1,1,0,0,0,5.64,17ZM5,12a1,1,0,0,0-1-1H3a1,1,0,0,0,0,2H4A1,1,0,0,0,5,12Zm7-7a1,1,0,0,0,1-1V3a1,1,0,0,0-2,0V4A1,1,0,0,0,12,5ZM5.64,7.05a1,1,0,0,0,.7.29,1,1,0,0,0,.71-.29,1,1,0,0,0,0-1.41l-.71-.71A1,1,0,0,0,4.93,6.34Zm12,.29a1,1,0,0,0,.7-.29l.71-.71a1,1,0,1,0-1.41-1.41L17,5.64a1,1,0,0,0,0,1.41A1,1,0,0,0,17.66,7.34ZM21,11H20a1,1,0,0,0,0,2h1a1,1,0,0,0,0-2Zm-9,8a1,1,0,0,0-1,1v1a1,1,0,0,0,2,0V20A1,1,0,0,0,12,19ZM18.36,17A1,1,0,0,0,17,18.36l.71.71a1,1,0,0,0,1.41,0,1,1,0,0,0,0-1.41ZM12,6.5A5.5,5.5,0,1,0,17.5,12,5.51,5.51,0,0,0,12,6.5Zm0,9A3.5,3.5,0,1,1,15.5,12,3.5,3.5,0,0,1,12,15.5Z"></path></svg>  <svg class="w-6 h-6 fill-current swap-off" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M21.64,13a1,1,0,0,0-1.05-.14,8.05,8.05,0,0,1-3.37.73A8.15,8.15,0,0,1,9.08,5.49a8.59,8.59,0,0,1,.25-2A1,1,0,0,0,8,2.36,10.14,10.14,0,1,0,22,14.05,1,1,0,0,0,21.64,13Zm-9.5,6.69A8.14,8.14,0,0,1,7.08,5.22v.27A10.15,10.15,0,0,0,17.22,15.63a9.79,9.79,0,0,0,2.1-.22A8.11,8.11,0,0,1,12.14,19.73Z"></path></svg></label>`;
});
const Navigation = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let $user, $$unsubscribe_user;
  $$unsubscribe_user = subscribe(user, (value) => $user = value);
  $$unsubscribe_user();
  return `<div class="flex items-center justify-between py-4"><div class="pl-8" data-svelte-h="svelte-24amqh"><h1 class="tracking-widest uppercase text-md md:text-xl text-primary">Scripturize</h1></div> <div class="flex justify-center gap-4 pr-8 tracking-wider md:gap-6 text-primary"><a href="/" class="transition duration-300 hover:text-secondary-focus hover:scale-105" data-svelte-h="svelte-7o7g2k">Home</a> <a href="/collection" class="transition duration-300 hover:text-secondary-focus hover:scale-105" data-svelte-h="svelte-1gw66qo">Collection</a> ${!$user ? `<a href="/login" class="transition duration-300 hover:text-secondary-focus hover:scale-105" data-svelte-h="svelte-1xz50ry">Login</a>` : `<a href="/logout" class="transition duration-300 hover:text-secondary-focus hover:scale-105" data-svelte-h="svelte-12d6vvk">Logout</a>`} ${validate_component(ThemeToggle, "ThemeToggle").$$render($$result, {}, {}, {})}</div></div>`;
});
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(AppShell, "AppShell").$$render($$result, {}, {}, {
    ...
    default: () => {
      return `<div class="flex flex-col items-center justify-center w-full h-full gap-6">${slots.default ? slots.default({}) : ``}</div>`;
    }
  })}`;
});
export {
